...
const mongooseSchema = require('../services/organizations/organizations.mongoose');
// !end
...
let moduleExports = function (app) {
  ...
  const organizations = new mongooseClient.Schema(mongooseSchema, { timestamps: true });
  // !end

  let existingModel = mongooseClient.models['organizations']; // needed for client/server tests
  let returns = existingModel || mongooseClient.model('organizations', organizations);
