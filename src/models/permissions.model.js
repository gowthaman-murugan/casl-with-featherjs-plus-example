...
const mongooseSchema = require('../services/permissions/permissions.mongoose');
// !end
...
let moduleExports = function (app) {
  ...
  const permissions = new mongooseClient.Schema(mongooseSchema, { timestamps: true });
  // !end

  let existingModel = mongooseClient.models['permissions']; // needed for client/server tests
  let returns = existingModel || mongooseClient.model('permissions', permissions);
