...
const mongooseSchema = require('../services/products/products.mongoose');
// !end
...
let moduleExports = function (app) {
  ...
  const products = new mongooseClient.Schema(mongooseSchema, { timestamps: true });
  // !end

  let existingModel = mongooseClient.models['products']; // needed for client/server tests
  let returns = existingModel || mongooseClient.model('products', products);
